...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WindowGUI_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 28, 12)
    ...
    "WindowGUI\0loadImg\0\0toBinImg\0toClusterImg\0"
};
...
void WindowGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->toBinImg(); break;
        case 2: _t->toClusterImg(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject WindowGUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_WindowGUI.data,
      qt_meta_data_WindowGUI,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WindowGUI.stringdata))
